...
class BCLModel(nn.Module):
    def __init__(self, num_classes=1000, name='resnet50', head='mlp', use_norm=True, feat_dim=1024,classifier = True):
    ...
    def forward(self, x):
        ...
        if self.classifier:
            ...
            logits = self.fc(feat)#用norm的话这里已经乘了30了
            temp = self.head_fc(self.fc.weight.T)
